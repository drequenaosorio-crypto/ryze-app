  ...
  return (
    <main className="min-h-screen bg-black text-white flex flex-col items-center justify-center px-6 text-center">
      ...
      <div className="w-full max-w-sm bg-white/10 border border-yellow-500/50 rounded-2xl p-6">
        ...
        <a 
          href={`https://wa.me/?text=${encodeURIComponent(`Únete a RYZE con mi link: ${link}`)}`}
          className="block w-full bg-[#25D366] text-black font-black py-4 rounded-2xl text-center"
        >
